...
<script src="https://cdn.jsdelivr.net/gh/ingttaetest/cdn/link-confirm/index.js"></script>
```
...
`data-comment`가 설정된 경우 기본 메세지보다 우전적으로 출력됩니다.
